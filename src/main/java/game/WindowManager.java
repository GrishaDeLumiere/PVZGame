...
public class WindowManager {
	...
	private static void SetupGame() {
	    ...
	    // Запускаем процесс загрузки ресурсов с прогрессом в отдельном потоке
	...
	private static void loadAllResourcesWithProgress() {
	    executeLoadingStep(() -> SettingsManager.loadSettings(), 25);
	    executeLoadingStep(() -> {
    ...
    private static void renderFPS() {
            GL11.glPushMatrix();
            GL11.glLoadIdentity();
            FontManager.getFont("FBUSV8C5EI").drawTextWithShadow(TimerUtils.getFpsString(),(int) ScaleToScreen.get(32), ScaleToScreen.get(55),ScaleToScreen.getTop(40), 0,new Color4f("#FFFFFF"),0.1f, 0.1f,0,true,0.1f,0.1f,new Color4f("#000000"));
            GL11.glPopMatrix();
    }
