 ...
 * Важные методы:
 * <ul>
 *     <li>{@link #loadAndPlayBackgroundMusic(String)}: Загружает и начинает воспроизведение музыки из файла. Если музыка уже воспроизводится, она не будет загружена повторно.</li>
 *     <li>{@link #stopBackgroundMusic()}: Останавливает воспроизведение текущей фоновой музыки и освобождает ресурсы.</li>
 *     <li>{@link #cleanup()}: Освобождает все ресурсы, связанные с музыкой, и останавливает воспроизведение.</li>
 * </ul>
 * <p>
 */
