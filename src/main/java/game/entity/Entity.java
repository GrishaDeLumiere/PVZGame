...
public abstract class Entity {
    ...
    public Entity(String name, float x, float y, float width, float height, int hp, int damage, float speed,
            float speedDamage, float hitboxWidth, float hitboxHeight) {
        this.name = name;
        this.x = x;
        this.y = y;
        this.width = width;
    ...
    public void render() {
        // Отрисовка тени
        TextureManager.drawTexture("shadow", ScaleToScreen.getStretchedWidth(x),
                ScaleToScreen.getStretchedHeight(y - 13), ScaleToScreen.getStretchedWidth(140),
                ScaleToScreen.getStretchedHeight(50));
        ...
        // Отрисовка юнити
        TextureManager.drawTexture(animation.getCurrentFrame(), ScaleToScreen.getStretchedWidth(x - 28),
                ScaleToScreen.getStretchedHeight(y - 1), ScaleToScreen.getStretchedWidth(width),
                ScaleToScreen.getStretchedHeight(height));
